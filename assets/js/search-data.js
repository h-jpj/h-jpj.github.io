...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%68%61%72%76%65%79%6A%61%79@%74%75%74%61.%69%6F", "_blank");
        },
      },{
        id: 'social-github',
        title: 'Github',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/Harvey-Jay Portas-Jones", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
